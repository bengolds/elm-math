...
var _user$project$ParserTests$imaginary = _elm_community$elm_test$Fuzz$constant(_user$project$MathTree$ImaginaryUnit);
var _user$project$ParserTests$varName = A2(_elm_community$elm_test$Fuzz$map, _elm_lang$core$String$fromChar, _elm_community$elm_test$Fuzz$char);
var _user$project$ParserTests$variable = A2(_elm_community$elm_test$Fuzz$map, _user$project$MathTree$Variable, _user$project$ParserTests$varName);
var _user$project$ParserTests$integer = A2(_elm_community$elm_test$Fuzz$map, _user$project$MathTree$Integer, _elm_community$elm_test$Fuzz$int);
var _user$project$ParserTests$rational = A2(_elm_community$elm_test$Fuzz$map, _user$project$MathTree$Rational, _elm_community$elm_test$Fuzz$float);
var _user$project$ParserTests$real = A2(_elm_community$elm_test$Fuzz$map, _user$project$MathTree$Real, _elm_community$elm_test$Fuzz$float);
var _user$project$ParserTests$tree = function (depth) {
	if (_elm_lang$core$Native_Utils.cmp(depth, 0) < 1) {
		return _elm_community$elm_test$Fuzz$oneOf(
			{
				ctor: '::',
				_0: _user$project$ParserTests$real,
				_1: {
					ctor: '::',
					_0: _user$project$ParserTests$rational,
					_1: {
						ctor: '::',
						_0: _user$project$ParserTests$integer,
						_1: {
							ctor: '::',
							_0: _user$project$ParserTests$variable,
							_1: {
								ctor: '::',
								_0: _user$project$ParserTests$imaginary,
								_1: {ctor: '[]'}
							}
						}
					}
					...
					_1: {
						...
						_1: {
							...
							_1: {
								...
								_1: {
									ctor: '::',
									_0: _user$project$ParserTests$differential(newDepth),
									_1: {
										ctor: '::',
										_0: _user$project$ParserTests$equals(newDepth),
										_1: {
											ctor: '::',
											_0: _user$project$ParserTests$func1(newDepth),
											_1: {
												ctor: '::',
												_0: _user$project$ParserTests$func2(newDepth),
												_1: {ctor: '[]'}
											}
										}
									}
...
var _user$project$ParserTests$differential = function (depth) {
	return A3(
		_elm_community$elm_test$Fuzz$map2,
		_user$project$MathTree$Differential,
		_user$project$ParserTests$tree(depth),
		_user$project$ParserTests$varName);
};
var _user$project$ParserTests$equals = function (depth) {
	return A3(
		_elm_community$elm_test$Fuzz$map2,
		_user$project$MathTree$Equals,
		_user$project$ParserTests$tree(depth),
		_user$project$ParserTests$tree(depth));
};
var _user$project$ParserTests$func1 = function (depth) {
	return A3(
		_elm_community$elm_test$Fuzz$map2,
...
var _user$project$ParserTests$func2 = function (depth) {
	return A4(
		_elm_community$elm_test$Fuzz$map3,
		_user$project$MathTree$Func2,
		_elm_community$elm_test$Fuzz$string,
...
var Elm = {};
Elm['ParserTests'] = Elm['ParserTests'] || {};
if (typeof _user$project$ParserTests$main !== 'undefined') {
    _user$project$ParserTests$main(Elm['ParserTests'], 'ParserTests', {"types":null,"versions":{"elm":"0.18.0"}});
}
