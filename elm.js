...
var _user$project$ParserUtils$formatContext = function (context) {
	return A2(
	...
	function (stack, source) {
		...
		return A2(
			...
			{ctor: '[]'},
			{
				...
				_0: _elm_lang$html$Html$text(
					_elm_lang$core$Basics$toString(
						A2(_user$project$ParserUtils$splitSource, splits, source))),
				_1: {ctor: '[]'}
			});
	});
				...
				},
				{
					...
					_1: {
						...
						_0: A2(
							_elm_lang$html$Html$ul,
							{ctor: '[]'},
							A2(_elm_lang$core$List$map, _user$project$ParserUtils$problemAsNode, _p3._0)),
						_1: {ctor: '[]'}
					}
				});
		} else {
	...
	return _elm_tools$parser$Parser$lazy(
		function (_p1) {
			return A2(
				...
				A2(
					_elm_tools$parser$Parser_ops['|.'],
					_elm_tools$parser$Parser$succeed(_user$project$LatexParser$Negative),
					_elm_tools$parser$Parser$symbol('-')),
				parser);
		});
};
			...
			return _elm_tools$parser$Parser$oneOf(
				{
					...
					_0: A2(
						_elm_tools$parser$Parser_ops['|='],
						_elm_tools$parser$Parser$succeed(_user$project$LatexParser$Constant),
