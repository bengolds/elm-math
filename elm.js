...
var _user$project$LatexParser$applyl = F2(
	function (fns, start) {
		applyl:
		while (true) {
			var _p3 = fns;
...
var _user$project$LatexParser$applyr = F2(
	function (fns, start) {
		return A2(
			_user$project$LatexParser$applyl,
		...
		return A2(
			...
			A2(
				...
				A2(
					_elm_tools$parser$Parser_ops['|.'],
					_elm_tools$parser$Parser$succeed(
						_user$project$MathTree$Apply1(_user$project$MathTree$Abs)),
					_user$project$LatexParser$command('left|')),
				_user$project$LatexParser$expr),
