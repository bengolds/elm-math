...
var _user$project$LatexParser$output = function (inputString) {
	var _p13 = A2(
		...
		_user$project$LatexParser$expr(_user$project$LatexParser$default),
		inputString);
	if (_p13.ctor === 'Ok') {
		return A2(
			_elm_lang$html$Html$div,
			...
			{
				ctor: '::',
				_0: _user$project$TypeAnalyzer$debugTree(_p13._0),
				_1: {ctor: '[]'}
			});
	} else {
		return _user$project$ParserDebugger$prettyPrintError(_p13._0);
	}
};
